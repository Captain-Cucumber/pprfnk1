...
This mechanism has been integrated into Bitcore-Node-Pprfnk which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pprfnk/insight-api-pprfnk#web-socket-api](https://github.com/pprfnk/insight-api-pprfnk#web-socket-api)
* API: [https://github.com/pprfnk/insight-api-pprfnk#instantsend-transactions](https://github.com/pprfnk/insight-api-pprfnk#instantsend-transactions)
...
By default, the Pprfnk Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pprfnk Core daemon:
