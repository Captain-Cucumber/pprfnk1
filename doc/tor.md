TOR SUPPORT IN PPRFNK CORE
=======================

It is possible to run Pprfnk Core as a Tor hidden service, and connect to such services.
...
1. Run Pprfnk Core behind a Tor proxy
----------------------------------

The first step is running Pprfnk Core behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./pprfnkd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./pprfnkd -proxy=127.0.0.1:9050


2. Run a Pprfnk Core hidden server
-------------------------------
...
your pprfnkd's P2P listen port (9988 by default).
	...
	-externalip=X   You can tell Pprfnk Core about its publicly reachable address using
	                ...
	                /var/lib/tor/pprfnkcore-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./pprfnkd -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./pprfnkd ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./pprfnkd -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known Pprfnk Core Tor relays
------------------------------------
...
Pprfnk Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Pprfnk Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Pprfnk Core is listening, and
