...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("0455e668c4bf7e51c779189441519f4ad5e08febefaee4395e74ac034b07d156624bee56ff9976cd5a8203f901e1cac277d1ea05f2056b6de3f82eba43c7120a3c") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Pprfnk: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Pprfnk: 2.5 minutes
        ...
        genesis = CreateGenesisBlock(1522055189, 288066, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000001b2ec509acef0ae8276d11b6229e577e0201cc66a1ba51c115b77d8ccb0"));
        assert(genesis.hashMerkleRoot == uint256S("0xe186397c206c4ccdb7ecca057d2cb613feaa521f7895323c24383586c15585d2"));
        ...
        strSporkPubKey = "044f253f9ac070471320b28b3e755111e3d142b905a0309d2441c21c3c4e818a4defb1239a3b5386a9c7743009e1e382f1f650211e33d97dbfd5becc01cf809590";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x000007aba3bc6719f8ca95b260ce73e35bdd36103faeb383a826d652aedb4389")),
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1522055190, 241972, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000064385d07b1da55f314270fb61f6d36692f8af126f8bc8679d1491c1b842"));
        assert(genesis.hashMerkleRoot == uint256S("0xe186397c206c4ccdb7ecca057d2cb613feaa521f7895323c24383586c15585d2"));
        ...
        // Testnet Pprfnk BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        strSporkPubKey = "04bfdc467027f06a6a6d7fa196e555df388f61967cdaf6965e40cc9ea9db424f33087fb1efb046ff1e97ddfdf56e906d570b2dc126361d034da9f47c12d2658c98";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000003f5e656c4a82eb44148b01478ea69d5d2a5694e20da75a7c3e6adaaa5c8")),

            1522055190, // * UNIX timestamp of last checkpoint block
            0,       // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0         // * estimated number of transactions per day after checkpoint
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1522055191, 3, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x58e35f033e2fd956f5ac7d1d023c56c0e39a1c7115936620cd92f2e6c66d47dc"));
        assert(genesis.hashMerkleRoot == uint256S("0xe186397c206c4ccdb7ecca057d2cb613feaa521f7895323c24383586c15585d2"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x65aeaa8e8f616a19e0b356bed60e2a3f77d04772dab2cf44da5ce0c5d9287536")),
            0,
            0,
            0
        };
        // Regtest Pprfnk addresses start with 't'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,127);
        // Regtest Pprfnk script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,20);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Pprfnk BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Pprfnk BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Pprfnk BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
