...
#define BOOST_TEST_MODULE Pprfnk Test Suite

#include "test_pprfnk.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_pprfnk_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
