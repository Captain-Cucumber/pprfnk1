    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Pprfnk Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pprfnk address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pprfnk: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Pprfnk Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pprfnk Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pprfnk Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pprfnk addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pprfnk addresses"));
    ...
    openAction->setStatusTip(tr("Open a pprfnk: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pprfnk Core help message to get a list with possible Pprfnk Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pprfnk Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pprfnk network", "", count));
    } else {
...
{
    QString strTitle = tr("Pprfnk Core"); // default title
