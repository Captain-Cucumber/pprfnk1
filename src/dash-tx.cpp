...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Pprfnk Core pprfnk-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pprfnk-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pprfnk transaction") + "\n" +
              "  pprfnk-tx [options] -create [commands]   " + _("Create hex-encoded pprfnk transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pprfnk transaction
