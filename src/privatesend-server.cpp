...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Pprfnk related functionality
...
/*
    ...
    allow endless transaction that would bloat Pprfnk and make it unusable. To
