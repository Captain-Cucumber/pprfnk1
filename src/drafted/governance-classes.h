 ...
 *
 *   // network
 *   CPprfnkNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.pprfnk.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPprfnkNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PprfnkNetwork
// //   -- signature requirements : Key1(User)
// class CPprfnkNetworkVariable : public CGovernanceObject
// {
// private:
