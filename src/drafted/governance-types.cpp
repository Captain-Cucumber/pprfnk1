...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PprfnkNetwork") type = PprfnkNetwork;
    if(strType == "PprfnkNetworkVariable") type = PprfnkNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PprfnkNetwork) s = "PprfnkNetwork";
    if(type == PprfnkNetworkVariable) s = "PprfnkNetworkVariable";
